...
$screen_template = [];
$screen_data = json_decode( file_get_contents( 'screen_data.json'), TRUE );

header( 'Content-type: text/html; charset=utf-8' );
//header('Cache-Control: no-cache'); // recommended to prevent caching of event data.

$screen_template['header'] = <<<EOF
<!-- >>> HEADER >>>------------------------------------------------ -->
<head>
...
<div>
    <fieldset>
        ...
        <details>
            <summary>sub</summary>
                 <iframe id="subframe" src="" title="Sub process frame" onload="this.width=screen.width-50;this.height=screen.height-200;"> </iframe> 
        </details>
    </fieldset>
</div>
EOF;
